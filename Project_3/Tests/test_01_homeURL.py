...
class TestHomeURL:
        ...
        # test_valid_url() checks whether the url navigates to the DEMO QA portal and checks the current url
        @pytest.mark.positive
        def test_valid_url(self):
            # This line creates an instance of the BasePage class, and passes the WebDriver instance (self.driver) to it.
            base_page = BasePage(self.driver)
            assert base_page.get_current_url() == "https://demoqa.com/"
            print("Properly navigated to DEMO QA portal")
        ...
        def test_invalid_url(self):
            # This line creates an instance of the BasePage class, and passes the WebDriver instance (self.driver) to it.
            base_page = BasePage(self.driver)
            assert base_page.get_current_url() == "https://demoqa.com/frames", "Incorrect URL"